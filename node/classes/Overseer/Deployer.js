...
var OverseerDeployer = /** @class */ (function (_super) {
    ...
    function OverseerDeployer(struct) {
        return _super.call(this, __assign(__assign(__assign({}, contractOutputs_1.overseerOutput), struct), { deployTransformer: function (struct) {
                var alchemillaEngine = new pollenium_buttercup_1.Address(struct.alchemillaEngine);
                var dai = new pollenium_buttercup_1.Address(struct.dai);
